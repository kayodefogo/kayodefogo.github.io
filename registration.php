				...
				<div class="box-register">
					<form name="registration" id="registration"  method="post">
						<fieldset>
							...
							<div class="form-group">
								<input type="text" class="form-control" name="NHIS_no" placeholder="NHIS Number" required>
							</div>
							<div class="form-group">
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> SWD</span>. <span>All rights reserved</span>
					</div>
